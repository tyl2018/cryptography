...
subq $9408, %rsp
mov $4, %ecx
karatsuba_loop_af8a13f776c196739c6cacf3744a148a:
mov %rsp, %r9
mov %rsp, %r10
subq $32, %rsp
vmovdqa 0(%rax), %ymm0
...
addq $32, %rsp
innerloop_af8a13f776c196739c6cacf3744a148a:
vmovdqa 0(%r9), %ymm0
...
neg %ecx
jns done_af8a13f776c196739c6cacf3744a148a
add $704, %r9
add $1408, %r10
jmp innerloop_af8a13f776c196739c6cacf3744a148a
done_af8a13f776c196739c6cacf3744a148a:
sub $704, %r9
sub $1408, %r10
vmovdqa 0(%r9), %ymm0
...
add $3072, %r12
dec %ecx
jnz karatsuba_loop_af8a13f776c196739c6cacf3744a148a
sub $12288, %r12
add $9408, %rsp
subq $2400, %rsp
...
vpand mask_1_15, %ymm8, %ymm3
vpaddw %ymm4, %ymm3, %ymm4
vpand mask_mod2048, %ymm4, %ymm4
vmovdqu %ymm4, 1352(%rdi)
vpshufb rol_rol_16, %ymm8, %ymm8
vpermq $216, %ymm8, %ymm8
vpshufb id_braid_16, %ymm8, %ymm8
vpermq $216, %ymm8, %ymm8
vpand mask_15_1, %ymm8, %ymm8
vmovdqu 0(%rdi), %ymm4
vpaddw %ymm4, %ymm8, %ymm4
vpand mask_mod2048, %ymm4, %ymm4
vmovdqu %ymm4, 0(%rdi)
...
vpand mask_1_15, %ymm4, %ymm9
vpaddw %ymm10, %ymm9, %ymm10
vpand mask_mod2048, %ymm10, %ymm10
vmovdqu %ymm10, 1352(%rdi)
vpshufb rol_rol_16, %ymm4, %ymm4
vpermq $216, %ymm4, %ymm4
vpshufb id_braid_16, %ymm4, %ymm4
vpermq $216, %ymm4, %ymm4
vpand mask_15_1, %ymm4, %ymm4
vmovdqu 0(%rdi), %ymm10
vpaddw %ymm10, %ymm4, %ymm10
vpand mask_mod2048, %ymm10, %ymm10
vmovdqu %ymm10, 0(%rdi)
