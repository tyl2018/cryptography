...
subq $9408, %rsp
mov $4, %ecx
karatsuba_loop_5b1aebd56b1550c1074feacf3e115ff8:
mov %rsp, %r9
mov %rsp, %r10
subq $32, %rsp
vmovdqa 0(%rax), %ymm0
...
addq $32, %rsp
innerloop_5b1aebd56b1550c1074feacf3e115ff8:
vmovdqa 0(%r9), %ymm0
...
neg %ecx
jns done_5b1aebd56b1550c1074feacf3e115ff8
add $704, %r9
add $1408, %r10
jmp innerloop_5b1aebd56b1550c1074feacf3e115ff8
done_5b1aebd56b1550c1074feacf3e115ff8:
sub $704, %r9
sub $1408, %r10
vmovdqa 0(%r9), %ymm0
...
add $3072, %r12
dec %ecx
jnz karatsuba_loop_5b1aebd56b1550c1074feacf3e115ff8
sub $12288, %r12
add $9408, %rsp
subq $2400, %rsp
