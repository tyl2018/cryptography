...
vpand mask_low13words, %ymm7, %ymm7
...
subq $6656, %rsp
mov $4, %ecx
karatsuba_loop_771ce2233a47ec1ff1bfe9861a82e4b2:
mov %rsp, %r9
mov %rsp, %r10
subq $32, %rsp
vmovdqa 0(%rax), %ymm0
...
addq $32, %rsp
innerloop_771ce2233a47ec1ff1bfe9861a82e4b2:
vmovdqa 0(%r9), %ymm0
...
neg %ecx
jns done_771ce2233a47ec1ff1bfe9861a82e4b2
add $512, %r9
add $1024, %r10
jmp innerloop_771ce2233a47ec1ff1bfe9861a82e4b2
done_771ce2233a47ec1ff1bfe9861a82e4b2:
sub $512, %r9
sub $1024, %r10
vmovdqa 0(%r9), %ymm0
...
add $2048, %r12
dec %ecx
jnz karatsuba_loop_771ce2233a47ec1ff1bfe9861a82e4b2
sub $8192, %r12
add $6656, %rsp
subq $2400, %rsp
...
vpand mask_mod2048, %ymm11, %ymm11
vmovdqa %ymm11, 0(%rdi)
vpand mask_mod2048, %ymm6, %ymm6
vmovdqa %ymm6, 256(%rdi)
vpand mask_mod2048, %ymm3, %ymm3
vmovdqa %ymm3, 512(%rdi)
vpand mask_mod2048, %ymm4, %ymm4
...
vpand mask_mod2048, %ymm5, %ymm5
vmovdqa %ymm5, 64(%rdi)
vpand mask_mod2048, %ymm6, %ymm6
vmovdqa %ymm6, 320(%rdi)
vpand mask_mod2048, %ymm10, %ymm10
vmovdqa %ymm10, 576(%rdi)
vpand mask_mod2048, %ymm9, %ymm9
...
vpand mask_mod2048, %ymm8, %ymm8
vmovdqa %ymm8, 640(%rdi)
vpand mask_mod2048, %ymm7, %ymm7
...
vpshufb shufmin5_mask3, %ymm10, %ymm10
...
vpshufb shufmin5_mask3, %ymm7, %ymm7
